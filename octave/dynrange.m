...
[b,a] = iirdesign(Nf, fc, fs, Nb);

% Look-ahead

b = [b(1), b(2)-a(2)*b(1), b(3) - a(2)*b(2), -a(2)*b(3)]
a = [a(1), 0, a(2)^2 - a(3), -a(2)*a(3)] 

% Transfer functions
sys = tf(b, a, 1/fs)
sys_ff = tf(sys.Num, [0 0 0 1], 1/fs)
sys_fb = tf([0 0 0 1], sys.Den, 1/fs)
sys_fb_t = tf(cell2mat(sys_fb.Den)(2:end), cell2mat(sys_fb.Num), 1/fs)
